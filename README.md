<p align="center">Desafio Lighthouse</p>
...
As informações e detalhes do Desafio seguem no arquivo de word "[Lighthouse] Desafio Cientista de Dados - Manutenção preventiva".

Este projeto foi desenvolvido no notebook em python. O modelo criado realiza a predição de falhas em máquinas a partir de variáveis da base dados. 
